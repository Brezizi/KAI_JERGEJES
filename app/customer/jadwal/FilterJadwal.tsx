...
const FilterJadwal = (myProp: props) => {
  ...
  const handleSearch = () => {
    if (departured_location !== "" && arrived_location !== "") {
      router.push(
        `/customer/jadwal?departured_location=${departured_location}&arrived_location=${arrived_location}`
      );
    }
  };
    ...
    <div>
      <div className="my-5 w-full flex flex-wrap items-center">
        <div className="w-full md:w-1/2 p-3">
          <strong className="text-white font-semibold">Stasiun Asal</strong>{" "}
          <br />
          <input
            type="text"
        ...
        <div className="w-full md:w-1/2 p-3">
          <strong className="text-white font-semibold">Stasiun Tujuan</strong>{" "}
          <br />
          <input
            type="text"
            id={`arrived_location`}
